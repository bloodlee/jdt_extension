...
public class SearchBaseAction implements IObjectActionDelegate {

	private Shell shell;
	
	private final UrlGenerator generator;
	
	public SearchBaseAction(UrlGenerator generator) {
		if (generator == null) {
			throw new IllegalArgumentException("Input generator couldn't be null.");
		}
				...
				if (iEditorSite != null) {
					...
					if (selectionProvider != null) {
						...
						if (!textSelection.isEmpty()) {
							MiscUtil.openBrowser(generator.gen(textSelection.getText()));
						} else {
