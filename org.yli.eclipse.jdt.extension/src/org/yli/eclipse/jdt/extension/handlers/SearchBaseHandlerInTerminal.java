...
public class SearchBaseHandlerInTerminal extends AbstractHandler {

	private final UrlGenerator generator;
	
	public SearchBaseHandlerInTerminal(UrlGenerator generator) {
		if (generator == null) {
			throw new IllegalArgumentException("Generator couldn't be null.");
		}
